      ...
      {(stats?.errorJobs ?? 0) > 0 && (
        <div className="mb-6 flex items-center gap-3 bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3">
          ...
          <p className="text-sm text-red-300">
            ...
            <Link to="/admin/jobs" className="underline hover:no-underline">Review in Jobs →</Link>
          </p>
        </div>
      )}
      ...
      <div className="grid lg:grid-cols-[1fr_260px] gap-6">
        ...
        <div className="bg-[#1e1e1e] rounded-2xl overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4">
            ...
            <Link to="/admin/jobs" className="text-xs text-[#C3C0FF] hover:underline flex items-center gap-1">
                ...
                <div key={job._id} className="flex items-center gap-3 px-5 py-3 hover:bg-[#262626]/40 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600 truncate mt-0.5">
                      {job.ownerEmail} · {timeAgo(job._creationTime)}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <Link to={`/orders/${job._id}`} target="_blank" className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-600 hover:text-gray-300 hover:bg-[#333] transition-colors">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-[#1e1e1e] rounded-2xl p-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/admin/jobs" className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-[#262626] transition-colors group">
                <div className="w-7 h-7 rounded-lg bg-[#2a2a2a] flex items-center justify-center shrink-0">
                  <Briefcase size={13} className="text-gray-400" />
                </div>
                <span className="text-sm font-medium text-white">All Jobs</span>
                <ArrowRight size={13} className="text-gray-600 ml-auto group-hover:text-gray-300 transition-colors" />
              </Link>
            </div>
          </div>
